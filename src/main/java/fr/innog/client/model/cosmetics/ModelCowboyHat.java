...
public class ModelCowboyHat extends ModModelHead {
	
	public IModelCustom model;
	
	public ResourceLocation texture = new ResourceLocation("craftyourliferp", "textures/cosmetics/cowboy_hat.png");	
	
	public ModelCowboyHat() {
	    this.model = AdvancedModelLoader.loadModel(new ResourceLocation("craftyourliferp", "models/cosmetics/cowboy_hat.obj"));
	}
	...
	public void applyTransformations(Entity entity)
	{
		 ...
		 GL11.glTranslatef(0F, 0.9F, 0.0F);
