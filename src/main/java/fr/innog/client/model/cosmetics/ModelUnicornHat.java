...
public class ModelUnicornHat extends ModModelHead {
	
	public IModelCustom model;
	
	public ResourceLocation texture = new ResourceLocation("craftyourliferp", "textures/cosmetics/unicorn_hat.png");	
	
	public ModelUnicornHat() {
	    this.model = AdvancedModelLoader.loadModel(new ResourceLocation("craftyourliferp", "models/cosmetics/unicorn_hat.obj"));
	}
