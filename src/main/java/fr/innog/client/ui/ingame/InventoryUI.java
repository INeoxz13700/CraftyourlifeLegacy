...
public class InventoryUI extends InventoryEffectRenderer implements IRecipeShownListener {
    ...
    public static final ResourceLocation INVENTORY_BACKGROUND = new ResourceLocation("craftyourliferp:ui/container/inventory.png");
    ...
    public void updateScreen() {
        if (this.mc.playerController.isInCreativeMode()) this.mc.displayGuiScreen(new CreativeInventoryUI(this.mc.player));
    ...
    public void initGui() {
        ...
        this.recipeBookGui.func_194303_a(this.width, this.height, this.mc, this.widthTooNarrow, ((CustomInventoryContainer)this.inventorySlots).craftMatrix);
    ...
    protected void actionPerformed(GuiButton button) throws IOException {
        if (button.id == 10) {
            this.recipeBookGui.initVisuals(this.widthTooNarrow, ((CustomInventoryContainer)this.inventorySlots).craftMatrix);
