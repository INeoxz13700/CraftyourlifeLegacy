...
public class CreativeInventoryUI extends InventoryEffectRenderer {

	    private static final ResourceLocation CREATIVE_INVENTORY = new ResourceLocation("craftyourliferp:ui/container/creative_inventory.png");
	    ...
	    public CreativeInventoryUI(EntityPlayer player)
	    {
	        super(new CreativeInventoryUI.ContainerCreative(player));
	        ...
	        else
	        {
	            ...
	            else if (selectedTabIndex == CreativeTabs.INVENTORY.getTabIndex())
	            {
	                ...
	                else if (type == ClickType.THROW && slotIn != null && slotIn.getHasStack())
	                {
	                    ...
	                    this.mc.playerController.sendSlotPacket(itemstack1, ((CreativeInventoryUI.CreativeSlot)slotIn).slot.slotNumber);
	                }
	                ...
	                {
	                    this.mc.player.inventoryContainer.slotClick(slotIn == null ? slotId : ((CreativeInventoryUI.CreativeSlot)slotIn).slot.slotNumber, mouseButton, type, this.mc.player);
	    ...
	    {
	        CreativeInventoryUI.ContainerCreative guicontainercreative$containercreative = (CreativeInventoryUI.ContainerCreative)this.inventorySlots;
	    ...
	    private boolean needsScrollBars()
	    {
	        ...
	        return selectedTabIndex != CreativeTabs.INVENTORY.getTabIndex() && CreativeTabs.CREATIVE_TAB_ARRAY[selectedTabIndex].shouldHidePlayerInventory() && ((CreativeInventoryUI.ContainerCreative)this.inventorySlots).canScroll();
	    }
	    ...
	    private void setCurrentCreativeTab(CreativeTabs tab)
	    {
	        ...
	        if (tab == CreativeTabs.INVENTORY)
	        {
	            ...
	            {
	                Slot slot = new CreativeInventoryUI.CreativeSlot(container.inventorySlots.get(l), l);
	    ...
	    public void handleMouseInput() throws IOException
	    {
	        ...
	        {
	            int j = (((CreativeInventoryUI.ContainerCreative)this.inventorySlots).itemList.size() + 9 - 1) / 9 - 5;
	            ...
	            ((CreativeInventoryUI.ContainerCreative)this.inventorySlots).scrollTo(this.currentScroll);
	        }
	    }
	    ...
	    protected void drawGuiContainerBackgroundLayer(float partialTicks, int mouseX, int mouseY)
	    {
	        ...
	        if(creativetabs == CreativeTabs.INVENTORY)
	        {
		        this.mc.getTextureManager().bindTexture(CREATIVE_INVENTORY);
	        }
	        else
	        {
	    ...
	    public static class ContainerCreative extends Container
	        {
	            ...
	            public ContainerCreative(EntityPlayer player)
	            {
	                ...
	                for (int i = 0; i < 5; ++i)
	                {
	                    for (int j = 0; j < 9; ++j)
	                    {
	                        this.addSlotToContainer(new CreativeInventoryUI.LockedSlot(CreativeInventoryUI.basicInventory, i * 9 + j, 9 + j * 18, 18 + i * 18));
	                    }
	                }
	            ...
	            public void scrollTo(float pos)
	            {
	                ...
	                for (int k = 0; k < 5; ++k)
	                {
	                    for (int l = 0; l < 9; ++l)
	                    {
	                        ...
	                        {
	                        	CreativeInventoryUI.basicInventory.setInventorySlotContents(l + k * 9, this.itemList.get(i1));
	                        }
	                        else
	                        {
	                        	CreativeInventoryUI.basicInventory.setInventorySlotContents(l + k * 9, ItemStack.EMPTY);
	                        }
	                    }
	                }
	            }
