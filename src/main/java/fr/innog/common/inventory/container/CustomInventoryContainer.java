package fr.innog.common.inventory.container;

import javax.annotation.Nullable;

import fr.innog.common.inventory.CustomInventoryPlayer;
import fr.innog.common.inventory.SlotBraid;
import fr.innog.common.inventory.SlotGiletBullet;
...
public class CustomInventoryContainer extends Container {
	    ...
	    public CustomInventoryContainer(EntityPlayer player, CustomInventoryPlayer customInventory)
	    {
	        ...
	        this.addSlotToContainer(new SlotBraid(customInventory, 0, 77, 44));	        
	        this.addSlotToContainer(new SlotGiletBullet(customInventory, 1, 77, 26));
	    }
