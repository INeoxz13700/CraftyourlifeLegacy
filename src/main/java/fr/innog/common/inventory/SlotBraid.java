...
public class SlotBraid extends Slot {

	public CustomInventoryPlayer customInventory;
	
    private static IInventory emptyInventory = new InventoryBasic("[Null]", true, 1);

	
	public SlotBraid(CustomInventoryPlayer customInventory, int index, int xPosition, int yPosition) {
    ...
    {
        return "craftyourliferp:items/empty_armor_slot_braid";
    }
    ...
    public boolean isItemValid(ItemStack stack)
    {
    	if(stack.getItem() instanceof DynamXItemArmor)
    	{
    		...
    		if(itemArmor.getInfo().getDescription().toLowerCase().contains("galon"))
    		{
                return true;
    		}
    	}
